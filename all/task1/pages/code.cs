...
namespace task1_1
{
    class Program
    {
        static void task1_1()
        {
            ...
            Console.WriteLine("Write down x to find polinom: p = a*x^4 - b*x^3 + c^x + d");
        ...
        static void task1_3()
        {   
            Console.WriteLine("Calculate the value of the function at point x, the value of which is entered from the console. If the input is not a number, display the corresponding message - Enter a number");
            ...
            if(x > 0)
            {
                Console.WriteLine("Answer for x = "+ x + ": " + (4*x-1));
            }else if (x < 0)
            {
                Console.WriteLine("Answer for x = "+ x + ": " + (25*x+10));
            }else
            {
                Console.WriteLine("Answer for x = "+ x + ": 0");
            }
        ...
        static void task1_4()
        {
            ...
            if(0<day && day<8)
            {
            Console.WriteLine("The "+ day + " is " + array[day-1]);
            }
        }
        static void task1_5()
        {
            ...
            while (Try1)
            {
            Console.Write("Enter numbers beetwen " + MIN_num + " and "+ MAX_num + " to sum: ");
            Try1 = int.TryParse(Console.ReadLine(), out num);
                ...
                {
                    Console.WriteLine("Error number is out of limit");
                }
        ...
        static void Main(string[] args)
        {
            ...
            while(flag)
            {
                ...
                {
                    Console.WriteLine("Error,  write an integer!!");
                }
